...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex min-h-10 w-full cursor-default items-center gap-2 rounded-xl py-1.5 pe-8 ps-3.5 text-sm font-normal text-foreground outline-hidden select-none focus:bg-muted/45 focus:text-foreground data-[highlighted]:bg-muted/45 data-[highlighted]:text-foreground data-[state=checked]:bg-muted/45 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
      <span className="pointer-events-none absolute end-3.5 flex size-4 items-center justify-center text-primary">
